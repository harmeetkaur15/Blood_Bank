...
<div id="main_container">
	...
	$id=$_GET['id'];
	include('conn.php');
	$a=mysqli_query($conn,"select * from st_addhospital where hid=$id");
	...
	?>
	<form method="post" action="updatehospital.php" enctype="multipart/form-data">
	<table width="500" border="1" align="center" bgcolor="#660066">
	<input type="hidden" name="hid" value="<?php echo $id1 ;?>"/>
	<tr bgcolor="#FFFFFF">
	  <td colspan="3" class="style8"><div align="center" class="style13">Edit Hospital</div></td>
	  </tr>
	<tr>
	<td width="118" class="style12">
	Hospital Name	</td>
	<td width="218"><input name="hname" type="text"  value="<?php echo $id2;?>"/>
	</td>
	</tr>
	<tr>
	<td width="118" class="style12">
	Hospital Address	</td>
	<td width="218"><input name="haddress" type="text"  value="<?php echo $id3;?>"/>
	</td>
	</tr>
	<td width="118" class="style12">
	Hospital Phone	</td>
	<td width="218"><input name="hphone" type="text"  value="<?php echo $id4;?>"/>
	</td>
