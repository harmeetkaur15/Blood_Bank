...
.style12 {font-size: 18px; font-weight: bold; color: #663366; }
.style14 {font-size: 18px; font-weight: bold; color: #660066; }
-->
</style>
</head>
<body>
...
$b11=mysqli_query($conn,
	"select d.did,d.name,d.age,d.gender,d.address,d.phone, b.code,b.bloodType,b.cost from st_donar d join bloodtype b ON d.bgtype = b.code where b.bloodtype = '$a'");
