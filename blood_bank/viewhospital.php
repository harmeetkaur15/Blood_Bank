...
{
var b=str;
var a=confirm('Are you sure to delete the hospital?');
//document.write(a);
if(a==true)
{
window.location="deletehospital.php?id="+b;
//document.write(str);
}
else
{
...
<tr bgcolor="#FFFFFF">
<th height="28"><span class="style15">Hospital Id</span></th>
...
$a=mysqli_query($conn,"select * from st_addhospital ");
...
<td align="center"><a href="edithospital.php?id=<?php echo $r[0];?>"><img src="images/user_edit.png" height="25px"</a></td>
