...
$b=$_POST['t2'];
include('conn.php');
$q=mysqli_query($conn,"select * from st_admin where uname='$a' && password='$b'");
...
<div id="main_container">
	...
	<div class="header_login">
      <div class="logo"> 
        <div align="center" style="color:white; font-size:1rem" ><a href="#"><img src="img/img1.png" alt="image" width="100" height="100" border="0" title="" /></a><br/>
         ...
         <h3 align="center" style="margin-left:270px">  Login</h3>
         ...
         <form action="" method="post" class="niceform">
                ...
                <fieldset>
                    <dl>
                        ...
                        <dd><input type="text" name="t1" id="t1" size="54" />
                        </dd>
                    </dl>
                    <dl>
                        <dt><label for="password">Password:</label></dt>
                        <dd><input type="password" name="t2" id="t2" size="54" />
                        </dd>
                    </dl>
					...
					if(isset($_POST['s']))
                    {
                    print "<font align='right' class='style4'>wrong username/password</font>";
    ...
    <div class="footer_login">
    	...
    	<div class="left_footer_login">Powered by Unfired</div>
