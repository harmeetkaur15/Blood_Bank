...
<div id="main_container">
    ...
    <div class="right_content">
      <form action="addemployee.php" method="post" enctype="multipart/form-data" name="f1">
	  <table width="445" height="171" border="0" align="center" bgcolor="#660066">
	  <tr bgcolor="#FFFFFF">
	  <td height="27" colspan="2"><div align="center" class="style11">Add Employee</div></td>
	  </tr>
	  <tr>
	  <td width="132" height="33"><span class="style4">Name</span></td>
...
include('conn.php');
$bb = "insert into st_employee(eid,name,address,phone)values(null,'$a','$b','$c')";
